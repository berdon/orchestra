...
function createServices(overrides?: Partial<OrchestraClientServiceBindings>): OrchestraClientServiceBindings {
  return {
    ...
    skills: {
      listSkills: vi.fn(async () => { throw new Error("unused"); }),
      getSkill: vi.fn(async () => { throw new Error("unused"); }),
      getCatalogDiagnostics: vi.fn(async () => { throw new Error("unused"); }),
      createLocalSkill: vi.fn(async () => { throw new Error("unused"); }),
      updateLocalSkill: vi.fn(async () => { throw new Error("unused"); }),
      archiveLocalSkill: vi.fn(async () => { throw new Error("unused"); }),
      unarchiveLocalSkill: vi.fn(async () => { throw new Error("unused"); }),
      deleteLocalSkill: vi.fn(async () => { throw new Error("unused"); }),
      refreshExternalSkills: vi.fn(async () => { throw new Error("unused"); }),
      setSkillBindings: vi.fn(async () => { throw new Error("unused"); }),
      getRoleSkillLinks: vi.fn(async () => { throw new Error("unused"); }),
      getAgentSkillLinks: vi.fn(async () => { throw new Error("unused"); }),
      getWorkflowSkillLinks: vi.fn(async () => { throw new Error("unused"); }),
      ...overrides?.skills,
    },
    notes: {
      list: vi.fn(async () => { throw new Error("unused"); }),
      get: vi.fn(async () => { throw new Error("unused"); }),
      update: vi.fn(async () => { throw new Error("unused"); }),
      delete: vi.fn(async () => { throw new Error("unused"); }),
      copy: vi.fn(async () => { throw new Error("unused"); }),
      move: vi.fn(async () => { throw new Error("unused"); }),
      createDirectory: vi.fn(async () => { throw new Error("unused"); }),
      deleteDirectory: vi.fn(async () => { throw new Error("unused"); }),
      copyDirectory: vi.fn(async () => { throw new Error("unused"); }),
      moveDirectory: vi.fn(async () => { throw new Error("unused"); }),
      ...overrides?.notes,
    },
    tasks: {
      list: vi.fn(async () => []),
      ...
      getPullRequest: vi.fn(async () => ({ taskId: "task-1", generatedAt: new Date().toISOString(), repositories: [] })),
