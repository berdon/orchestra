...
This will likely reduce coupling versus putting workflow advancement logic directly inside session management, and keeps permission resolution separate from workforce/runtime behavior.
