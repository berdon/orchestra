...
use commands::{
    ...
    app::{
        ...
        export_logs_bundle, get_app_info, get_bridge_diagnostics,
        get_harness_model_limits_snapshot, get_logs, get_pi_executable_diagnostic,
        ...
        get_source_control_settings, get_system_notification_environment_status,
        get_system_notification_permission_state, import_legacy_pi_configuration,
        import_pi_legacy_config, list_pi_models, open_logs_window, preview_pi_legacy_import,
        remove_pi_provider_credential, report_client_error, request_system_notification_permission,
        save_harness_model_limit_policy, save_pi_models_json, send_system_notification,
    ...
    notes::{
        copy_project_note, copy_project_notes_directory, create_project_notes_directory,
        delete_project_note, delete_project_notes_directory, get_project_note, list_project_notes,
        move_project_note, move_project_notes_directory, update_project_note,
    },
    policies::{
    ...
    project_settings::{
        create_project_secret, delete_project_secret, get_project_secrets,
        get_project_source_control_settings, get_session_prompt_settings,
        get_task_automation_settings, get_worker_overlay, update_project_secret,
        update_project_source_control_settings, update_session_prompt_settings,
        update_task_automation_settings, update_worker_overlay,
    },
    projects::{
    ...
    task_browser::{
        debug_eval_task_browser, get_task_browser_state, navigate_task_browser,
        reveal_task_browser_dom_anchor, set_task_browser_inspect_mode, show_task_browser,
        task_browser_page_state_changed,
    },
    task_schedules::{
    ...
    tasks::{
        ...
        delete_task_todo, dispatch_task_lane, download_task_attachment, get_task,
        get_task_comment_delete_impact, get_task_context, get_task_file_content,
        get_task_pull_request, list_task_attachments, list_task_comments,
        list_task_file_references, list_task_repositories, list_task_todos, list_tasks,
        list_unfinished_task_todos, manual_task_whip, mark_task_comments_read_for_user, mark_task_needs_work,
        mark_task_todo_finished, mark_task_todo_unfinished, pause_task_lane, reassign_task_to_lane,
        remove_task_attachment, remove_task_dependency, remove_task_file_reference,
        request_user_intervention, reset_task_runtime, resume_task_lane,
        search_task_comment_file_mentions, search_task_comments, send_lane_back_for_work,
...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            copy_project_note,
            move_project_note,
            create_project_notes_directory,
            delete_project_notes_directory,
            copy_project_notes_directory,
            move_project_notes_directory,
            run_dispatcher_tick,
            get_session_storage_info,
            get_pi_runtime_settings,
            update_pi_runtime_settings,
            get_harness_model_limits_snapshot,
            save_harness_model_limit_policy,
            get_pi_setup_state,
