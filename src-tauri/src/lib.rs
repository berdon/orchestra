...
use commands::{
    ...
    app::{
        ...
        debug_expire_task_whip_cooldown, debug_seed_idle_task_whip_scenario,
        dismiss_pi_legacy_import, dismiss_pi_oauth_flow, export_logs_bundle, get_app_info,
        get_bridge_diagnostics, get_harness_model_limits_snapshot, get_logs,
        ...
        request_system_notification_permission, save_harness_model_limit_policy,
    ...
    tasks::{
        ...
        delete_task_todo, dispatch_task_lane, download_task_attachment,
        get_task, get_task_attachment_content, get_task_comment_delete_impact,
        get_task_context, get_task_file_content,
...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            open_logs_window,
            debug_expire_task_whip_cooldown,
