            ...
            <section className="task-section task-section--compact" data-role="system-notifications-panel">
              <div className="task-section__header">
                <div>
                  ...
                  <p className="supporting-copy">Enable local browser/macOS notifications for this client. In hosted web, Orchestra uses Web Push as the primary notification path whenever this paired browser has a push subscription on HTTPS/localhost, even if the page is already open.</p>
                </div>
              ...
              {systemNotificationEnvironment?.reason ? (
                ...
                <p className="supporting-copy">If Orchestra is missing from Notification Center or browser prompts were dismissed, refresh the status, request permission again, and send a test notification. In hosted web, a subscribed push-capable browser now uses Web Push as its notification surface even while the page is foregrounded, which keeps the behavior consistent across foreground, background, and closed-browser states. Without a push subscription, hosted-web delivery falls back to best-effort live connected-client notifications only. Background Web Push additionally requires a secure origin (HTTPS or localhost); some mobile browsers may also require an installed web app context.</p>
              ) : (
