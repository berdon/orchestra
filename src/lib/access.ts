...
export const PERMISSION_OPTIONS: PermissionOption[] = [
  ...
  { key: "projects.secrets.read", group: "Projects", label: "View project secret metadata", description: "List project-scoped secret keys and metadata without reading raw values.", risk: "sensitive" },
  { key: "projects.secrets.use", group: "Projects", label: "Use project secrets", description: "Load project-scoped secret values into the current session environment for tool use.", risk: "sensitive" },
  { key: "projects.secrets.write", group: "Projects", label: "Manage project secrets", description: "Create, rotate, update, and delete project-scoped secrets.", risk: "sensitive" },
